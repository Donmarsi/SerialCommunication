...
namespace SerialCommunication
{
    public partial class Form1 : Form
    {
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    else if (radioButtonHandshakeXonXoff.Checked) serialPortArduino.Handshake = Handshake.RequestToSendXOnXOff;
                    ...
                    {
                        serialPortArduino.Close();
                        labelStatus.Text = "Error: verkeerd antwword";
        ...
        private void checkBoxDigital4_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    ...
                    if (checkBoxDigital3.Checked) commando = "set d4 high";
        ...
        // OEF 4: potentiometer analoge ingangen
